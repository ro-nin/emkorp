...
export function getSortedProjectsData(locale = 'en-US') {
    ...
    const designProjects = allprojectsData.filter(proj => proj.category === 'designProjects');
    ...
    const allProjects = { 'projects': { 'allProjects': allprojectsData.sort(sortMethod), 'webProjects': webProjects.sort(sortMethod), 'gameProjects': gameProjects.sort(sortMethod),'designProjects': designProjects.sort(sortMethod) } }
